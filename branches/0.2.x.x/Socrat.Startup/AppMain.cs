...
namespace Socrat.Startup
{
    ...
    public static class AppMain
    {
        ...
        /// </summary>
        public static Model.Users.User User { get; set; }
        ...
        public static void Init()
        {
            ...
            Model.Constants.CurrentUser = User;

            Logger.AddInfo("Загрузка параметров приложения");
            AppParams.Params.Load();
            using (DivisionRepository repo = new DivisionRepository())
            {
                Guid _id;
                Guid.TryParse(AppParams.Params[ParamAlias.CurrentDivision], out _id);
                Model.Constants.CurrentDivision = repo.GetItem(_id);
            }
        ...
        private static bool Authentificate()
        {
            using (UserRepository _repo = new UserRepository())
                User = _repo.GetUserByLogin(Environment.UserName);
            return true;
            return User != null;
        }
        ...
        public static void LoadTab(ITabable form)
        {
            if (MainForm != null)
                MainForm.LoadTab(form);
            else
        ...
        public static void LoadFormTabByName(string formTypeName, bool readOnly = false)
        {
        ...
        public static void LoadModuleTab(string moduleName, bool readOnly = false)
        {
        ...
        private static string GetAppUserSettingsFileName()
        {
            return Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) +
                   @"\" + Environment.UserName + "_" + Properties.Settings.Default.AppUserSettingsFileName;
        }
