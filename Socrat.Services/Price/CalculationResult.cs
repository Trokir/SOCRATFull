...
namespace Socrat.Services.Price
{
    public class CalculationResult : ICalculationResult
    {
        ...
        /// Перечень замен
        /// </summary>
        public List<IReplacement> Replacements { get; } = new List<IReplacement>();

        /// <summary>
        /// Перечень модификаторов цены
        /// </summary>
        public List<IPriceModificator> Modificators { get; } = new List<IPriceModificator>();
        ...
        /// </summary>
        public List<IReplacement> BaseMaterials
        {
            get => Replacements.Where(replacement => replacement.Order == 0).ToList();
        }

        /// <summary>
        /// Перечень замен компонентов изделия
        /// </summary>
        public List<IReplacement> ComponentMaterials
        {
            get => Replacements.Where(replacement => replacement.Order > 0).ToList();
        }
        ...
        /// </summary>
        public List<IReplacement> BaseReplacements { get => Replacements.Where(replacement => replacement.Order == 0).ToList(); }
        ...
        public List<IReplacement> AdditionalReplacements { get => Replacements.Where(replacement => replacement.Order > 0).ToList(); }
        ...
        public List<IReplacement> UnpricedReplacements { get => Replacements.Where(replacement => replacement.Order < 0).ToList(); }

        public List<IPriceModificator> PerMeasurementUnitFactors
        {
            get => Modificators
                .Where(modificator =>
                    modificator.ModificatorType == PriceModificatorTypes.Multiplicator
                    && modificator.ApplianceType == PriceApplianceTypes.PerMeasurementUnit).ToList();
        }
        ...
        /// </summary>
        public List<IPriceModificator> PerMeasurementUnitAdditionalValues
        {
            get => Modificators
                .Where(modificator =>
                    modificator.ModificatorType == PriceModificatorTypes.AdditionalValue
                    && modificator.ApplianceType == PriceApplianceTypes.PerMeasurementUnit).ToList();
        }
        ...
        /// </summary>
        public List<IPriceModificator> PerItemFactors
        {
            get => Modificators
                .Where(modificator =>
                    modificator.ModificatorType == PriceModificatorTypes.Multiplicator
                    && modificator.ApplianceType == PriceApplianceTypes.PerItem).ToList();
        }
        ...
        /// </summary>
        public List<IPriceModificator> PerItemAdditionalValues
        {
            get => Modificators
                .Where(modificator =>
                    modificator.ModificatorType == PriceModificatorTypes.AdditionalValue
        ...
        /// </summary>
        public List<IPriceModificator> UnpricedModificators
        {
            get => Modificators
                .Where(modificator =>
                    modificator.ModificatorType == PriceModificatorTypes.Unknown
                    || modificator.ApplianceType == PriceApplianceTypes.Unknown).ToList();
        }
        ...
        public double BasePricePerItem
        {
            get
            {
                ...
                if (Request.ItemType == ProductionTypes.Spd || Request.ItemType == ProductionTypes.Spo)
                {
        ...
        public double PricePerItem
        {
            get
            {
                if (Request.OrderRow.PriceCalculationType == PriceCalculationTypes.Automatic)
                {
                ...
                return Request.OrderRow.PriceItem ?? 0;
            }
        }
        ...
        /// </summary>
        public double PricePerMeasurementUnit
        {
