...
{
    public sealed class Shape_37 : Rectangular
    {
        public Shape_37(List<ShapePoint> ShapePoints, List<dynamic> currentShapeParametersList) : base(ShapePoints, currentShapeParametersList)
        {
        }
        ...
        public override void GetShapeComponents()
        {
            ...
            using (Pen pen = new Pen(Color.Blue, SizeLineBoundArgument))
            {
                ...
                ShapePoint hcenter = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, SetPointCurrentValueY(A) - lh.Length / 2);
                ...
                ShapePoint b2s = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, SetPointCurrentValueY(B));
                ShapePoint b2e = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, X_Base.PointY);
                graphicsShape.DrawLine(pen, b2s, b2e);
                Line b2h = GetNewLine(b2s, b2e);
                ShapePoint b2scenter = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, X_Base.PointY + b2h.Length / 2);
                ...
                ShapePoint l1scenter = GetNewCustomPoint(SetPointCurrentValueX(A) + l1h.Length / 2, W_Base.PointY + 10 * LineBoundArgument);
                graphicsShape.DrawString("L1=" + SetCurrentSize(SetL1), drawFontBold, Brushes.Black, l1scenter, sf);

                ShapePoint b2s1 = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, SetPointCurrentValueY(A));
                ShapePoint b2e1 = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, W_Base.PointY);
                graphicsShape.DrawLine(pen, b2s1, b2e1);
                Line b2h1 = GetNewLine(b2s1, b2e1);
                ShapePoint b21scenter = GetNewCustomPoint(Z_Base.PointX + 30 * LineBoundArgument, W_Base.PointY - b2h1.Length / 2);
                ...
                ShapePoint le = GetNewCustomPoint(SetPointCurrentValueX(C), W_Base.PointY + 30 * LineBoundArgument);
                ...
                ShapePoint b3e = GetNewCustomPoint(SetPointCurrentValueX(A), W_Base.PointY + 30 * LineBoundArgument);
                ...
                ShapePoint b1s = GetNewCustomPoint(SetPointCurrentValueX(C), W_Base.PointY + 30 * LineBoundArgument);
                ...
                if (Area > 0.012)
                {
                    ...
                    graphicsShape.DrawString("37", drawNumbertBold, Brushes.Black, mCustCenter, sf);
                }
                using (Pen pens = new Pen(Color.Blue, SizeLineBoundArgument / 2))
                {
                    ...
                    ShapePoint wer3 = GetNewCustomPoint(Z_Base.PointX, SetPointCurrentValueY(D));
                    ...
                    graphicsShape.DrawLine(pens, ls, l1s);
        ...
        public override double SetH_t
        {
            ...
            get
            {
                ShapePoint s = GetNewCustomPoint(CCheck.PointX, DCheck.PointY);
                Line line = GetNewLine(s, CCheck);
        ...
        public override double SetL1_t
        {
            get
            {
                ...
                Line lqw = GetNewLine(s, BCheck);
                return Math.Round(lqw.Length, 0);
            }
        }
        protected override void SetHValue()
        {
            base.SetHValue();
            var pr = B.PointY;
            ShapePoint p = GetNewCustomPoint(C.PointX, D.PointY);
            C.PointY = SetCurrentLineLength(p, C, _SetH).PointY;
            B.PointY = C.PointY;
            var diff = pr - B.PointY;
            Move(y: diff);
            ValidValue = false;
        }
