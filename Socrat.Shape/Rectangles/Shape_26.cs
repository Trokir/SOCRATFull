...
{
    sealed class Shape_26 : Rectangular
    {
        ...
        public Shape_26(List<ShapePoint> ShapePoints, List<dynamic> currentShapeParametersList) : base(ShapePoints, currentShapeParametersList)
        {
            ACheck1 = GetNewPoint();
            ACheck2 = GetNewPoint();
            BCheck1 = GetNewPoint();
        ...
        public override void GetShapeComponents()
        {
            ...
            using (Pen pen = new Pen(Color.Blue, SizeLineBoundArgument))
            {
                ...
                ShapePoint b12center = GetNewCustomPoint(Z_Base.PointX + 20, Z_Base.PointY - (bl2.Length / 2));
                ...
                if (Area > 0.012)
                {
                    ...
                    graphicsShape.DrawString("26", drawNumbertBold, Brushes.Black, mCustCenter, sf);
                }
                using (Pen pens = new Pen(Color.Blue, SizeLineBoundArgument / 2))
                {

                    //Core.Entities.Core.Entities.ShapePoint wer = GetNewCore.Entities.Core.Entities.ShapePoint(W_Base.PointX, ACheck.Y);
                    //Core.Entities.Core.Entities.ShapePoint wer1 = GetNewCore.Entities.Core.Entities.ShapePoint(Z_Base.PointX, DCheck.Y);
                    //using (pen1 = new Pen(Color.Black, ThiсknessArgument / 2))
                    //{
                    //    graphicsShape.DrawLine(pen1, wer, ACheck);
                    //    graphicsShape.DrawLine(pen1, wer1, DCheck);
                    //}
        ...
        protected override void SetLValue()
        {
            ...
            //  C.PointY = SetCurrentLineLength(B, C, _SetL).PointY;
            D.PointX = C.PointX;
            ValidValue = false;
        }
        /// <summary>
