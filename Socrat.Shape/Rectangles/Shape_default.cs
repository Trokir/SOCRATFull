   ...
   sealed class Shape_0 : Rectangular
    {
        ...
        public override void GetShapeComponents()
        {
            ...
            using (Pen pen = new Pen(Color.Blue, SizeLineBoundArgument))
            {
                ...
                ShapePoint ls = GetNewCustomPoint(A.PointX, W_Base.PointY + 10 * LineBoundArgument);
                ShapePoint le = GetNewCustomPoint(D.PointX, W_Base.PointY + 10 * LineBoundArgument);
                Line ll = GetNewLine(ls, le);
                ShapePoint lcenter = GetNewCustomPoint(A.PointX + (ll.Length / 2), W_Base.PointY + 12 * LineBoundArgument);
