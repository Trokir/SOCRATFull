...
{
    sealed class Shape_28 : Rectangular
    {
        ...
        private ShapePoint TempCecnter { get; set; }
        private double curRadius { get; set; }
        private double ControlRadius { get; set; }
        private Rectangle rect { get; set; }
        private Pen blackPen { get; set; }
        public Shape_28(List<ShapePoint> ShapePoints, List<dynamic> currentShapeParametersList) : base(ShapePoints, currentShapeParametersList)
        {
            Apogeus = GetNewPoint();
        ...
        public override void GetShapeComponents()
        {
            ...
            using (Pen pen = new Pen(Color.Blue, SizeLineBoundArgument))
            {
                ...
                ShapePoint bhcenter = GetNewCustomPoint(Z_Base.PointX + 15 * LineBoundArgument, Z_Base.PointY - (blh.Length / 2));
                ...
                ShapePoint bsh1 = GetNewCustomPoint(Z_Base.PointX + 40 * LineBoundArgument, SetPointCurrentValueY(B));
                ShapePoint beh1 = GetNewCustomPoint(Z_Base.PointX + 40 * LineBoundArgument, SetPointCurrentValueY(A));
                Line blh1 = GetNewLine(bsh1, beh1);
                ShapePoint b1hcenter = GetNewCustomPoint(Z_Base.PointX + 40 * LineBoundArgument, W_Base.PointY - (blh1.Length / 2));
                ...
                ShapePoint b3e = GetNewCustomPoint(Z_Base.PointX + 40 * LineBoundArgument, X_Base.PointY + SetB3);
                Line lb3 = GetNewLine(b3s, b3e);
                ShapePoint b3center = GetNewCustomPoint(Z_Base.PointX + 40 * LineBoundArgument, X_Base.PointY + lb3.Length / 2);
                ...
                if (Area > 0.012)
                {
                    ...
                    graphicsShape.DrawString("28", drawNumbertBold, Brushes.Black, mCustCenter, sf);
                }
                using (Pen pens = new Pen(Color.Blue, SizeLineBoundArgument / 2))
                {
                    ...
                    graphicsShape.DrawLine(pens, beh1, wer2);
                    graphicsShape.DrawLine(pens, b12e11, W_Base);
                    graphicsShape.DrawLine(pens, b12e1, Z_Base);

                    ShapePoint wer5 = GetNewCustomPoint(Y_Base.PointX, Y_Base.PointY + SetB3);
                    graphicsShape.DrawLine(pens, b3e, wer5);
        ...
        {
            base.SetHValue();
          //  Move(0, SetChord + CheckCut2 + SetB1);
        ...
        protected override void SetChordValue()
        {
            base.SetChordValue();
