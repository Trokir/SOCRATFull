    ...
    public partial class Heptagon : BaseShape
    {
        protected override void DrawMainLines()
        {
            using (Pen pen = new Pen(Color.Black, 1))
            {
                ...
                graphicsShape.DrawLine(pen, G, A);
            }
        }
        ...
        public override void GetShapeComponents()
        {
            ...
            {
                graphicsShape.DrawPath(pen1, MakeRoundCorner(B, A, G, SetA_radius));
                ...
                graphicsShape.DrawPath(pen1, MakeRoundCorner(F, G, A, SetG_radius));
                ...
                graphicsShape.DrawLine(pen1, A2, B2);
                ...
                graphicsShape.DrawLine(pen1, G1, A1);
        ...
        protected override double CorrectingRadiusForShapeAngles(Core.Entities.ShapePoint firstPoint, Core.Entities.ShapePoint secondPoint, Core.Entities.ShapePoint thirdPoint, double radius)
        {
            ...
            if (aL.Length >= bL.Length && radius > bL.Length / 2)
            {
                ...
                if (Math.Round(radius, 0) == Math.Round(SetG_radius, 0)) { radius = bL.Length / 2; SetG_radius = (float)Math.Round(radius, 0); }
            }
        ...
        public override void GetExtremumPoints()
        {
            ...
            FPointX = GeTextremumPoint(G, GrF, SetG_radius);
            List<Core.Entities.ShapePoint> pointList = new List<Core.Entities.ShapePoint>() { A1, B1, C1, D1, E1, F1, G1, A2, B2, C2, D2, E2, F2, G2, APointX, BPointX, CPointX, DPointX, EPointX, FPointX, GPointX };
