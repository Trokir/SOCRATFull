...
namespace Socrat.References
{
        ...
        where T : class, IEntity, new()
    {
        ...
        public event EventHandler<List<T>> ItemSelectionChanged;
        ...
        protected void InitializeComponent()
        {
            ...
            this.layoutControl.Controls.Add(this.gcGrid);
            ...
            // _gcGrid
            // 
            this.gcGrid.Location = new System.Drawing.Point(2, 42);
            this.gcGrid.MainView = this.gvGrid;
            this.gcGrid.Name = "gcGrid";
            this.gcGrid.Size = new System.Drawing.Size(881, 661);
            this.gcGrid.TabIndex = 7;
            this.gcGrid.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvGrid});
            this.gcGrid.DoubleClick += new System.EventHandler(this.gcGrid_DoubleClick);
            this.gcGrid.KeyDown += new System.Windows.Forms.KeyEventHandler(this.CxTableList_KeyDown);
            // 
            // _gvGrid
            // 
            ...
            this.gvGrid.OptionsBehavior.AutoPopulateColumns = false;
            this.gvGrid.OptionsBehavior.Editable = false;
            this.gvGrid.OptionsBehavior.ReadOnly = true;
            this.gvGrid.OptionsClipboard.CopyColumnHeaders = DevExpress.Utils.DefaultBoolean.False;
            this.gvGrid.OptionsFind.AlwaysVisible = true;
            this.gvGrid.OptionsFind.ClearFindOnClose = false;
            this.gvGrid.OptionsSelection.MultiSelect = true;
            this.gvGrid.PopupMenuShowing += new DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventHandler(this._gvGrid_PopupMenuShowing);
            this.gvGrid.SelectionChanged += new DevExpress.Data.SelectionChangedEventHandler(this._gvGrid_SelectionChanged);
            this.gvGrid.FocusedRowChanged += new DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventHandler(this._gvGrid_FocusedRowChanged);
            this.gvGrid.ColumnFilterChanged += new System.EventHandler(this._gvGrid_ColumnFilterChanged);
            // 
            // pcSelectButton
            // 
            ...
            // lciTable
            // 
            this.lciTable.Control = this.gcGrid;
        ...
        protected virtual void OnItemSelectionChanged(int[] selectedRowsHandles)
        {
            ...
            foreach (var idx in selectedRowsHandles)
            {
                if (gvGrid.GetRow(idx) is T rowObject)
                    SelectedItems.Add(Items.First(dataObject => dataObject.Id == rowObject.Id));
            }
