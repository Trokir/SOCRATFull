...
namespace Socrat.References
{
...

    {
        ...
        public Func<T2> SelectionFormFiltersSetup { get; set; }
        public Func<T3> EditorFormFiltersSetup { get; set; }
        ...
        public ButtonEditAssistent(ButtonEdit editor, T1 entity, Action<WindowOutputEventArgs> onDialogOutput)
        {
            ButtonEdit = editor;
            _value = entity;
        ...
        {
            if (SelectionFormFiltersSetup != null)
                return SelectionFormFiltersSetup.Invoke();
        ...
        {
            if (EditorFormFiltersSetup != null)
                EditorFormFiltersSetup.Invoke();
