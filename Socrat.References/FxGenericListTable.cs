...
{
    public partial class FxGenericListTable<T> : FxBaseForm, ISelectionDialog, ISelectionDialogFilterable<T>
        where T : class, IEntity, new()
    {
        ...
        private void CxTableListOnDeleteItemEvent(object sender, ListItemEventArgs e)
        {
            ...
            DialogResult dlgRes = XtraMessageBox.Show(string.Format("Удалить {0}?", _entity), "Удаление",
        ...
        private void InitializeComponent()
        {
            System.ComponentModel.ComponentResourceManager resources =
                new System.ComponentModel.ComponentResourceManager(typeof(FxGenericListTable));
        ...
        private void OnItemSaved(T item)
        {
