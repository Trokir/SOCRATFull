...
{
   public class CatalogShapeParamConfiguration : EntityTypeConfiguration<CatalogShapeParam>
    {
        public CatalogShapeParamConfiguration()
        {
            ToTable("CatalogShapeParam");
            HasKey(p => p.Id);
            ...
            HasRequired(e => e.CatalogShape)
                 .WithOptional(e => e.CatalogShapeParam);
        }
    }
}
