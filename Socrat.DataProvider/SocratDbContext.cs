...
namespace Socrat.DataProvider
{
    public partial class SocratEntities : DbContext
    {
        ...
        public virtual DbSet<FormulaItemProcessing> FormulaItemProcessings { get; set; }
        public virtual DbSet<ProcessingComponent> ProcessingComponents { get; set; }
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new FormulaItemProcessingConfiguration());
            modelBuilder.Configurations.Add(new ProcessingComponentConfiguration());
